...
Reads the CSV produced by the dt_viterbi_metrics harness and renders, for each channel
...
Usage:
    build/metrics/viterbi/dt_viterbi_metrics > metrics/viterbi/metrics.csv
    python3 metrics/viterbi/plot_metrics.py metrics/viterbi/metrics.csv -o metrics/viterbi/plots/
"""
import argparse
import csv
import os
...
def main():
    ...
    ap.add_argument("csv", help="CSV from dt_viterbi_metrics")
