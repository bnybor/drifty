...
Reads the CSV produced by the dt_maxir_metrics harness and renders, for each channel
...
Usage:
    build/metrics/maxir/dt_maxir_metrics > metrics/maxir/metrics.csv
    python3 metrics/maxir/plot_metrics.py metrics/maxir/metrics.csv -o metrics/maxir/plots/
"""
import argparse
import csv
import os
...
def main():
    ...
    ap.add_argument("csv", help="CSV from dt_maxir_metrics")
