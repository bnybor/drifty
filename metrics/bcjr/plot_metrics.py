...
Reads the CSV produced by the dt_bcjr_metrics harness and renders, for each channel
...
Usage:
    build/metrics/bcjr/dt_bcjr_metrics > metrics/bcjr/metrics.csv
    python3 metrics/bcjr/plot_metrics.py metrics/bcjr/metrics.csv -o metrics/bcjr/plots/
"""
import argparse
import csv
import os
...
def main():
    ...
    ap.add_argument("csv", help="CSV from dt_bcjr_metrics")
