...
Reads the CSV produced by the dt_vindel_metrics harness and renders, for each channel
...
Usage:
    build/metrics/vindel/dt_vindel_metrics > metrics/vindel/metrics.csv
    python3 metrics/vindel/plot_metrics.py metrics/vindel/metrics.csv -o metrics/vindel/plots/
"""
import argparse
import csv
import os
...
def main():
    ...
    ap.add_argument("csv", help="CSV from dt_vindel_metrics")
